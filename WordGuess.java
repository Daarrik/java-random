...
public class WordGuess {
  ...
  public static double game() throws FileNotFoundException {
    ...
    while (!guessed) {
      // Print out incorrectly guessed letters and then prompt the user for the next
      // letter.
  ...
  // Creates the array that hides the word. The last value in the array is the
  // word itself.
  ...
  // User inputted guess. Recursive call if not a single letter. Makes capital
  // letters lowercase.
  ...
  // Checks if there is any '-' or "=" left in the word. False if remaining, true
  // otherwise.
